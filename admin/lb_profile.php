            ...
            <tbody>
             <tr>
              ...
              <td>
               ...
               <a href="../admin/admin_profile_detail.php?id=<?= $list->id; ?>"
                class="btn btn-success btn-sm pull-right">Profile</a>
               <?php elseif($list->role_id == 2) : ?>
               <a href="../admin/lb_profile_detail.php?id=<?= $list->id; ?>"
                class="btn btn-success btn-sm pull-right">Profile</a>
               <?php elseif($list->role_id == 3) : ?>
               <a href="../admin/tr_profile_detail.php?id=<?= $list->id; ?>"
                class="btn btn-success btn-sm pull-right">Profile</a>
               <?php elseif($list->role_id == 4) : ?>
               <a href="../admin/st_profile_detail.php?id=<?= $list->id; ?>"
                class="btn btn-success btn-sm pull-right">Profile</a>
               <?php elseif($list->role_id == 5) : ?>
               <a href="../admin/user_profile_detail.php?id=<?= $list->id; ?>"
                class="btn btn-success btn-sm pull-right">Profile</a>
