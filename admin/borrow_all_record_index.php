...
$borrows = $borrow_table->getAllRecordBorrow();
        ...
        <div class="card">
         <div class="card-header card-header-success card-header-icon">
          ...
          <h4 class="card-title">BooK Borrow Dashboard <span><a href="borrow_create_form.php"
             class="btn btn-primary btn-round">+ New Book Borrow</a> <span><a href="borrow_index.php"
              class="btn btn-warning btn-round">Back</a></span></span></h4>
         </div>
         <div class="card-body">
