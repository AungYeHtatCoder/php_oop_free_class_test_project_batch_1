        ...
        <div class="col-md-4">
         ...
         <div class="card card-product">
          ...
          <div class="card-footer">
           ...
           <div class="stats">
            <p class="card-category"><i class="material-icons">place</i> Posted By : <?= $post->name ?></p>
           </div>
          </div>
         </div>
       ...
       <div class="card card-profile">
        <div class="card-avatar">
         <?php 
          ...
          if($get_no_auth_profile->profile === null):
          ?>
         <img src="../_actions/profile/<?= $get_no_auth_profile->profile?>" alt="">
         <?php else: ?>
         <a href="#pablo">
            ...
            <tbody>
             <tr>
              ...
              <td>
               ...
               <a href="../admin/admin_profile.php?id=<?= $list->id; ?>"
                class="btn btn-success btn-sm pull-right">Profile</a>
               <?php elseif($list->role_id == 2) : ?>
               <a href="../admin/lb_profile.php?id=<?= $list->id; ?>"
                class="btn btn-success btn-sm pull-right">Profile</a>
               <?php elseif($list->role_id == 3) : ?>
               <a href="../admin/tr_profile.php?id=<?= $list->id; ?>"
                class="btn btn-success btn-sm pull-right">Profile</a>
               <?php elseif($list->role_id == 4) : ?>
               <a href="../admin/st_profile.php?id=<?= $list->id; ?>"
                class="btn btn-success btn-sm pull-right">Profile</a>
               <?php elseif($list->role_id == 5) : ?>
               <a href="../admin/user_profile.php?id=<?= $list->id; ?>"
                class="btn btn-success btn-sm pull-right">Profile</a>
